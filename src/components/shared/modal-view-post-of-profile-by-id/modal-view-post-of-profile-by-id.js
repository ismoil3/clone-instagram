...
const ModalViewProfileByIdPost = () => {
    ...
    const { personPostsById: posts, inputsById, likePostById, addCommentToPostById, setInputById, getUsers, getPersonById, personById, personId, getPersonPostsById, initialSlideById } = useProfileById()
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {bp.w767 &&
                        <div onClick={setCloseModalViewPost} className={` ${dm ? 'bg-[#111]' : 'bg-white'} cursor-pointer sticky top-0 z-50 p-1 w-full`}>
                                    ...
                                    >
                                        ...
                                        {bp.w767 &&
                                            <div className={`flex justify-between sticky top-0 h-fit ${dm ? 'bg-[#111]' : 'bg-white'} z-50 items-center border-b-[1px] p-3`}>
                                                <div className='flex gap-4 items-center'>
                                                    <div
                                                        style={{
                                                            backgroundImage: `url("${apiSoftInsta + '/images/' + personById.image
                                                                }")`
                                                        }}
                                        ...
                                        <div style={{ scrollbarWidth: 'none' }} className='flex flex-col overflow-auto justify-between'>
                                            <div className=''>
                                                ...
                                                {i == initialSlideById && <SwipableDrawer isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)}>
                                            ...
                                            <div className={`items-start flex flex-col border-t-[1px] sticky bottom-0 ${dm ? 'bg-[#111]' : 'bg-white'} z-50 border-gray-500/40 w-full`}>
                                                <div className='flex justify-between w-full px-4 py-2'>
                                                    <div className='flex items-center w-fit gap-2'>
                                                        <IconButton
                                                            color='error'
                                                            onClick={() => likePostById(post.postId)}
                                                        >
                                                            {post.postLike ? (
                                                                <Favorite
                                                                    sx={{
...
export default ModalViewProfileByIdPost