...
const ModalSubSettings = ({ isOpen, onClose, id }) => {
    const { personById, personId } = useProfileById()
            ...
            >
                <div className='relative flex flex-col justify-center border-b-[1px] border-gray-500/40 py-2'>
                    <div className="flex flex-col gap-1 p-4 items-center">
                        <div style={{ backgroundImage: `url("${apiSoftInsta + '/images/' + personById.image}")` }} className="size-[55px] bg-cover bg-center border rounded-full flex flex-col items-center justify-center">
                            {personById.image ? (
                                <Image
                        ...
                        <div className='flex items-center flex-col'>
                            <p className="font-[700]">{personById.userName}</p>
                            <p className="font-[600]">{personById.firstName} {personById.lastName}</p>
                        </div>
                    </div>
...
export default ModalSubSettings;