  ...
  return (
    <>
      ...
      >
        ...
        >
          {bp.w767 &&
            <div onClick={setCloseModalViewPost} className={` ${dm ? 'bg-[#111]' : 'bg-white'} cursor-pointer z-50 sticky top-0 p-1 w-full`}>
                  ...
                  >
                    ...
                    >
                      {post.images.map((item, index) => (
                        <SwiperSlide className={`${dm ? 'bg-[#111]' : 'white'}`} key={index}>
                          <div
                            onDoubleClick={(e) => {
                              handleDoubleClick(e)
